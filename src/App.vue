...
<button class="hamburger" id="hamburger">
    ...
    <template v-if="quizState === 'complete'">
      ...
      <form id="frm" lang="it" action="https://formsubmit.co/da4833c2fc5e05cf2b842f3ba7964ce0" method="POST">
        ...
        <input  v-if="Number(score)>7" type="hidden" lang="it" name="_autoresponse" value="Utilizza il codice QUIZ25 per ottenere un sconto del un codice del 10% sul tuo prossimo ordine!">
        ...
        <input  v-if="Number(score)>7" type="hidden" lang="it" name="_autoresponse" value="Utilizza il codice QUIZ25 per ottenere un sconto del un codice del 20% sul tuo prossimo ordine!">
      ...
      <input  v-if="Number(score)>8" type="hidden" lang="it" name="_autoresponse" value="Utilizza il codice QUIZ25  per ottenere uno sconto del 30% sul tuo prossimo ordine!">

      <p v-if="Number(score)>9">Congratulazioni, hai vinto! Lascia la tua mail e ti invieremo uno coupon per uno sconto del: 40%</p>
      <input  v-if="Number(score)>9" type="hidden" lang="it" name="_autoresponse" value="Utilizza il codice QUIZ25 per ottenere un sconto del 40% sul tuo prossimo ordine!">
     ...
     <br>
     <!----<input type="hidden" name="_url" value="grazie.html">--->
